...
category: Advice
front-page: false
deck: "A job search often starts with one search term: Graphic Designer. That term covers only part of the field. Postings use many other titles for the same work."
permalink: /articles/job-titles-and-sector.html
---
...
Sectors listed under a direction are strong fits for that direction. They are not the only fits. A generalist can find work in a specialist sector. A specialist can often find work in a generalist role too.
...
- National sport organizations, many headquartered in Ottawa
